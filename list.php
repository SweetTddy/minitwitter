...
<div class="container-narrow">
	<div class="jumbotron offset2 well swell-small span5">

		<ul class="nav nav-tabs">
		  <li class="active"><a href="#follow" data-toggle="tab">Users you follow</a></li>
		  <li><a href="#following" data-toggle="tab">Users follow you</a></li>
		  <li><a href="#intresting" data-toggle="tab">Intresting users</a></li>		  
		</ul>
				...
				<?php
					...
					foreach ($followers_data as $key => $fd) {
						...
						if($current_user_follow_check)
							$follow_button = '<p><button data-method="follow" data-userid="$uid" type="button" class="follow-unfollow btn-mini btn-primary pull-right">Unfollow</button></p>';
						else
							$follow_button = '<p><button data-method="unfollow" data-userid="$uid" type="button" class="follow-unfollow btn-mini btn-warning pull-right">Follow</button></p>';
